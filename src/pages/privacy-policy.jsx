...
export default function PrivacyPolicy() {
    return (
      <>
        <Head>
          <title>Privacy Policy - DAO Day Estonia</title>
        ...
        <div className="bg-white py-32 px-6 lg:px-8">
            <div className="mx-auto max-w-5xl text-base leading-7 text-blue-900">
                <h1 className="text-3xl font-bold tracking-tight text-blue-600 sm:text-4xl">Privacy Policy</h1>
                ...
                <h2 className="mt-16 text-2xl font-bold tracking-tight text-blue-900">Who we are</h2>
                <p className="mt-6 text-base leading-8">
                ...
                <h2 className="mt-16 text-2xl font-bold tracking-tight text-blue-900">What data do we collect and keep?</h2>
                <p className="mt-6 text-base leading-8">We collect and keep the following personal data:</p>
                <ul className="mt-6 text-base leading-8 list-disc list-inside">
                  <li>Your first and last name</li>
                  <li>The name of the company you work for and your job title</li>
                  <li>The country you come from</li>
                  <li>Your email address</li>
                  <li>Your phone number</li>
                  <li>The category in which you fall under – guest, investor, media, student, speaker, startup</li>
                  <li>Postal code</li>
                </ul>
                <p className="mt-6 text-base leading-8">
                ...
                <h2 className="mt-16 text-2xl font-bold tracking-tight text-blue-900">When do we collect your personal data?</h2>
                <ul className="mt-6 text-base leading-8 list-disc list-inside">
                  <li>You use our website</li>
                  <li>You purchase a conference ticket</li>
                  <li>You sign up for media accreditation via our media accreditation application form</li>
                  <li>You sign up to be a conference volunteer via our volunteer sign-up form</li>
                </ul>
                <h2 className="mt-16 text-2xl font-bold tracking-tight text-blue-900">Why do we collect and use your personal data?</h2>
                <p className="mt-6 text-base leading-8">
                ...
                <ul className="mt-6 text-base leading-8 list-disc list-inside">
                  <li>To send you marketing communications that you have requested. These may include information and updates about the DAO Day Estonia conference itself (e.g., venue, side activities, related content, conference program and any other relevant details about the conference), our conference tickets, our conference sponsors, promotions related to our conference and tickets and promotions of our associated sponsors and partners’ products or services. This communication is based on subscription and requires your consent</li>
                  <li>To send you information about your conference ticket(s) that you have purchased from us</li>
                  <li>To perform direct sales activities in cases where legitimate and mutual interest is established</li>
                  <li>To notify you about any problems or disruptions related to the  DAO Day Estonia conference</li>
                </ul>
                <p className="mt-6 text-base leading-8">
                ...
                <h2 className="mt-16 text-2xl font-bold tracking-tight text-blue-900">What happens when you visit our website – the use of cookies, web beacons, tags and scripts</h2>
                <p className="mt-6 text-base leading-8">
                ...
                <ul className="mt-6 text-base leading-8 list-disc list-inside">
                  ...
                  <li>Analyze and monitor conversions of our ticket sales</li>
                </ul>
                <p className="mt-6 text-base leading-8">
                ...
                <ul className="mt-6 text-base leading-8 list-disc list-inside">
                  <li><a class="underline" href="https://support.google.com/chrome/answer/95647?co=GENIE.Platform%3DDesktop&hl=en" rel="noreferrer nofollow" target="_blank">Google Chrome</a></li>
                  <li><a class="underline" href="https://support.mozilla.org/en-US/kb/delete-cookies-remove-info-websites-stored" rel="noreferrer nofollow" target="_blank">Mozilla Firefox</a></li>
                </ul>
                <p className="mt-6 text-base leading-8">
                ...
                <p className="mt-6 text-base leading-8">
                If you would like to learn more about cookies, clear gifs/web beacons and related technologies, you may wish to visit <a class="underline" href="http://www.allaboutcookies.org" rel="noreferrer nofollow" target="_blank">http://www.allaboutcookies.org</a> and/or the Network Advertising Initiative’s online resources at <a class="underline" href="http://www.networkadvertising.org" rel="noreferrer nofollow" target="_blank">http://www.networkadvertising.org</a>.
                </p>
                <h2 className="mt-16 text-2xl font-bold tracking-tight text-blue-900">Legal basis for collecting your personal data</h2>
                <h3 className="mt-6 text-xl leading-8 text-blue-900">Collecting personal data based on consent</h3>
                <p className="mt-6 text-base leading-8">
                ...
                <h3 className="mt-6 text-xl leading-8 text-blue-900">Collecting personal data based on legitimate interest</h3>
                <p className="mt-6 text-base leading-8">
                ...
                <h3 className="mt-6 text-xl leading-8 text-blue-900">How long do we keep your personal data?</h3>
                <p className="mt-6 text-base leading-8">
                ...
                <h3 className="mt-6 text-xl leading-8 text-blue-900">Do we share your data with anyone?</h3>
                <p className="mt-6 text-base leading-8">
                ...
                <h2 className="mt-16 text-2xl font-bold tracking-tight text-blue-900">Your rights to your personal data</h2>
                <p className="mt-6 text-base leading-8">
                You have the following rights with respect to your personal data:
                </p>
                <ul className="mt-6 text-base leading-8 list-disc list-inside">
                  <li>The right to request a copy of your personal data that DAO Day Estonia retains about you</li>
                  <li>The right to request that DAO Day Estonia corrects your personal data if inaccurate or out of date</li>
                  <li>The right to request that your personal data is deleted when it is no longer necessary for DAO Day Estonia to retain such data</li>
                  <li>The right to withdraw any consent to personal data processing at any time. For example, your consent to receive our newsletters:</li>
                  <li>If you want to withdraw your consent to our newsletters, please make use of the ‘unsubscribe’ link at the bottom of our newsletters to manage your subscriptions</li>
                  <li>If you want to withdraw your consent to our press releases, please let us know by sending an email to us at dao@internetnative.org</li>
                  <li>The right to request that DAO Day Estonia provides you with your personal data and, if possible, to pass on this information directly (in a portable format) to another data controller when the processing is based on consent or contract</li>
                ...
                <p className="mt-6 text-base leading-8">
                Any query about your privacy rights should be sent to dao@internetnative.org
                </p>
                <h2 className="mt-16 text-2xl font-bold tracking-tight text-blue-900">Amendments to this Privacy Policy</h2>
                <p className="mt-6 text-base leading-8">
                ...
                <h3 className="mt-6 text-xl leading-8 text-blue-900">Your right to complain with a supervisory authority</h3>
                <p className="mt-6 text-base leading-8">
                If you are unhappy with the way your personal data has been processed, you may, in the first instance, contact dao@internetnative.org
                </p>
                <p className="mt-6 text-base leading-8">
                ...
                <p className="mt-6 text-base leading-8 font-bold">
